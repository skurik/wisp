...
router.get('/', function (req, res, next) {
  ...
  var authUri = config.spotifyAuthUriPath + '?client_id=' + config.spotifyClientId + '&response_type=code&state=0&scope=' + encodeURIComponent(config.spotifyAuthScopes) + '&redirect_uri=' + encodeURIComponent(config.authRedirectUri);
